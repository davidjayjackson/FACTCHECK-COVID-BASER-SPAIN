---
title: 'UNOFFICAL Spain Speaks: Spain''s Battle w/ COVID-19'
...
EUCOVID <- read.csv("../DATA/COVID-19-ECDPC-2020-08-01.csv")
...
lines(spain$dateRep,spain$deaths,col="blue",ylim=c(0,max(spain$deaths)+100))
legend("topleft",
...
lines(UK$dateRep,UK$cases,col="red",ylim=c(0,max(spain$cases)+100))
legend("topleft",
